...
## Assignment 3 packaging (clarity + rigor + side-by-side)

### Run mapping used

- stable baseline (tiny anchor): `results/experiments/hybrid_replanner_eval/hybrid_calvin_debug_real_aligned_20260331T103029Z`
- tiny VL-3B rerun: `results/experiments/hybrid_replanner_eval/hybrid_calvin_debug_real_aligned_3b_qual_pilot_rerun`
- tiny VL-7B rerun: `results/experiments/hybrid_replanner_eval/hybrid_calvin_debug_real_aligned_7b_qual_pilot_rerun`
- base vs tuned quantitative: `results/eval/planner_base_vs_tuned/metrics.json`

### Base vs tuned (directly comparable, n=73)
...
### Tiny 3-case qualitative (same backend/batch/seed/episodes)
...
- baseline rejection reasons: `target_absent_from_scene_memory` and `drawer_goal_target_mismatch`
- terminal failures remain dominated by `repeated_no_effect_fallback_exhausted` across tracks

### Report-ready asset pointers

- main tables: `docs/final_report_assets/tables/current_main_results_table.md`
- side-by-side cases: `docs/failure_cases/hybrid_replanner_cases.md`
- tiny qualitative summary: `docs/final_report_assets/case_studies/tiny_3case_qualitative_summary.md`
- copy-ready paragraphs: `docs/final_report_assets/assignment3_report_ready_text.md`